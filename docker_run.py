...
if __name__=="__main__":
    ...
    parser.add_argument("-c", "--container", type=str, default="6-881-final-project", help="(optional) name of the container")
    ...
    cmd += " -v '%(source_dir)s/PDDL_plan':/6-881-final/ " % {'source_dir': source_dir}
